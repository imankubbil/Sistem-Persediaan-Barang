        ...
        <div class="block full">                            
            <div class="block-title">
                <div class="block-options">
                    <h2 class="pull-right"><strong><a href="<?=base_URL()?>laporan_barangkeluar" data-toggle="tooltip" title="Refresh" class="btn btn-xs btn-default"><i class="fa fa-refresh"></i></a></strong></h2>
                </div>
            </div>

                  <?=form_open_multipart('laporan_barangkeluar/lihat', array('id' => 'lapbarangkeluar'))?>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group form-actions">
                        ...
                        <a href="<?= base_url('admin/barang_keluar')?>" class="btn btn-sm btn-warning"><i class="fa fa-repeat"></i> Batal</a>
                    </div>
                  <?=form_close()?>
              </div>
        </div>
