...
<html lang="id">
  ...
  <body onload="window.print()">
    <header class="clearfix">
      ...
      <h1>LAPORAN BARANG MASUK - PT. AGEL LANGGENG</h1>
      ...
      <table align="center">
        <thead>
          <tr>
            ...
            <th style="text-align: center">No Barang Masuk</th>                        
            <th style="text-align: center">Tanggal Barang Masuk</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align: center"><?=$p->no_brgmasuk?></td>
            <td style="text-align: center"><?=$p->tgl_masuk?></td>
            <td style="text-align: center"><?=getSupp($p->kode_supp)?></td>
          ...
          <?php $no++; endforeach ?>
            ...
            <td colspan="5" class="grand total">TOTAL BARANG MASUK : </td>
