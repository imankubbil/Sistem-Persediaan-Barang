    ...
    <div class="content-header">
      <div class="header-section">
        ...
        <div class="block">
          ...
          <form action="<?=base_url('admin/kategori_tambah')?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">

            <div class="form-group">
              <label class="col-md-3 control-label" for="example-text-input">Kode Kategori</label>
                <div class="col-md-3">
                  <input type="text" name="kode_kategori" value="<?=$kodeunik?>" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group form-actions">
              <div class="col-md-9 col-md-offset-3">
                ...
                <a href="<?=base_url('admin/kategori')?>" class="btn btn-sm btn-warning"><i class="fa fa-repeat"></i> Batal</a>
              </div>
            </div>
          </form>
